...
describe("GET /companies", function () {
  ...
  describe("GET /companies w/filters", function () {
    test("filters by min and max", async function () {
    ...
    test("filters by name, min, and max", async function () {
      const resp = await request(app).get(
        "/companies?name=c&minEmployees=0&maxEmployees=2"
      );
